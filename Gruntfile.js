...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    exec: {
      ...
      desktopsign: {
        cmd: 'gpg -u ADC3F980 --output webkitbuilds/<%= pkg.title %>-linux.zip.sig --detach-sig webkitbuilds/<%= pkg.title %>-linux.zip ; gpg -u ADC3F980 --output webkitbuilds/<%= pkg.title %>.exe.sig --detach-sig webkitbuilds/<%= pkg.title %>.exe'
      },
      desktopverify: {
